...
<title>{:GetVar('webtitle')} - 代理中心</title>
						...
						<div class="m-m-cen ym-grid">
							<div class="mem-agent m-a-one m-m-subnav tab pos-r">
								<ul class="level2-nav tabHd">
									...
									<?php  if($proxy == 1) {?><li onclick="contractUserList();">契约合同</li><?php }?>
								</ul>
											...
											<div class="m-a-n-bd subTabBd">
												<div class="">
													<div class="sjss">
														...
														<span>&nbsp;&nbsp;时间：</span>
														<input class="layriqi" type="text" id="indexStartDate" onclick="laydate({format:'YYYY-MM-DD',isclear:false});" readonly>
														<span class="zhi">-</span>
														<input class="layriqi" type="text" id="indexEndDate" onclick="laydate({format:'YYYY-MM-DD',isclear:false});" readonly>
...
<div class="m-a-n-bd tabBd">
												<div class="tb-imte cur" style="display: block;">
													<div class="m-warm-prompt">
														...
														<p>3. 固定推广链接：<span class="mark">https://{$_SERVER['HTTP_HOST']}/Public.register.tgid.<way way-data="user.id"></way></span></p>
													</div>
													<div class="m-a-kaihu">
														<dl class="ty-biaodan">
															<dd>
										...
										<table class="mem-biao">
											<thead>
												<tr>
													<th colspan="8">
														<span>创建时间：</span>
														<input type="text" id="userSearchStartTime" onclick="laydate({format:'YYYY-MM-DD',isclear:false});" readonly>
														<span>-</span>
														<input type="text" id="userSearchEndTime" onclick="laydate({format:'YYYY-MM-DD',isclear:false});" readonly>
														<span>余额：</span>
										...
										<table class="mem-biao">
											<thead>
												<tr>
													<th colspan="8">
													<span>创建时间：</span>
													<input type="text" id="userOnlineSearchStartTime" onclick="laydate({format:'YYYY-MM-DD',isclear:false});" readonly>
													<span>-</span>
													<input type="text" id="userOnlineSearchEndTime" onclick="laydate({format:'YYYY-MM-DD',isclear:false});" readonly>
													<span>余额：</span>
							...
							<table class="mem-biao">
								<thead>
									<tr>
										<th colspan="12">
											<span>下单时间：</span>
											<input type="text" id="downUserBetsSearchStartTime" onclick="laydate({format:'YYYY-MM-DD',isclear:false});" readonly>
											<span>-</span>
											<input type="text" id="downUserBetsSearchEndTime" onclick="laydate({format:'YYYY-MM-DD',isclear:false});" readonly>
											<span>订单号：</span>
							...
							<table class="mem-biao">
								<thead>
									<tr>
										<th colspan="8">
											<span>开始时间：</span>
											<input class="layriqi starTime" id="accountChangeStartTime" type="text" onclick="laydate({format:'YYYY-MM-DD',isclear:false});" readonly>
											<span class="zhi">结束时间：</span>
											<input class="layriqi endTime" id="accountChangeEndTime" type="text" onclick="laydate({format:'YYYY-MM-DD',isclear:false});" readonly>
											<span>用户名：</span>
...
<option value="{$fk}"> {$ft}</option>
							...
							<table class="mem-biao">
								<thead>
									<tr>
										<th colspan="10">
											<span>开始时间：</span>
											<input class="layriqi starTime" id="groupDepositStartTime" type="text" onclick="laydate({format:'YYYY-MM-DD',isclear:false});" readonly>
											<span class="zhi">结束时间：</span>
											<input class="layriqi endTime" id="groupDepositEndTime" type="text" onclick="laydate({format:'YYYY-MM-DD',isclear:false});" readonly>
											<span>用户名：</span>
						...
						<div class="mar-lr20 tb-imte" style="display:none">
							<table class="mem-biao" id="groupReport">
								<thead>
									<tr>
										<th colspan="8">
											<span>开始时间：</span>
											<input class="layriqi starTime" id="groupReportStartTime" type="text" onclick="laydate({format:'YYYY-MM-DD',isclear:false});" readonly>
											<span class="zhi">结束时间：</span>
											<input class="layriqi endTime" id="groupReportEndTime" type="text" onclick="laydate({format:'YYYY-MM-DD',isclear:false});" readonly>
											<span>用户名：</span>
							...
							<!--契约合同-->
						<div class="tb-imte" id="contractUserList" style="display:none">
						<div style="paging:10px;">
						<div class="m-a-nav-min tab">
										
								<div class="m-a-n-bd tabBd">
												<div class="tb-imte cur" style="display: block;">
												
													<div class="m-a-kaihu" style="font-size:16px">
														<dl class="ty-biaodan">
															<dd style="  height: 80px;border: 1px solid #607D8B;width: 95%; margin-left: 15px;background-color:#EEEEEE;">
																<span class="tt" style="background-image: url(/images/1111.png);margin-left: 15px;width: 60px;height: 72px;line-height: 65px;text-align: center;color: #212121;"><i>签约</i></span>
																 <?php if($clres['days'] == 1){?><span style="margin-left: 15px;width: 690px;height: 72px;color: #546E7A;">
																 您已签定日契约，日契约充值量需达到 <?php echo $res['days']?> 元，达到后可领取分红<?php echo $res['ratio']?>% 即 <?php echo $res['days']?> 乘 <?php echo $res['ratio']?>%
																...
																<span class="layui-progress-text"><?php echo $days_arr['transferIn']?> = <?php echo $days_arr['percent']?>%</span>
																</div>
																</div>
																温馨提示：分红结算时间为契约签定时间开始至结束为准，超时契约到期自动取消
																</span>
																<?php } else {?>
																<span style="margin-left: 15px;width: 690px;height: 72px;color: #546E7A;">
																...
																<?php }?>
																<span style="display:inline-block;  margin-left: <?php if($clres['days'] == 1){?>2.3%<?php }else {?>2.3%<?php }?>;  line-height: 4em;">
																	 <?php if($clres['days'] == 1 && $days_arr['percent'] < 100){?>
																	<a class="in-but-l w-16" href="javascript:;">已签约</a>
																	<?php } else if($clres['days'] == 1 && $days_arr['percent'] >= 100 &&  $days_zufeData == true) {?> 
																	<a class="in-but-l w-16" href="javascript:;" onclick="drawshare('days');">领取分红</a>
																	<?php } else if( $days_zufeData == false) {?>
																	<a class="in-but-l w-16" href="javascript:;" onclick="contractLog('days',1);">契约已作废，请重新签订</a>
																	<?php } else {?>

																	<a class="in-but-l w-16" href="javascript:;" onclick="contractLog('days',1);">未签约</a>
																	<?php }?>
																</span>
															</dd>
															<dd style=" height: 80px;border: 1px solid #607D8B;width: 95%;margin-left: 15px; margin-top:15px;background-color:#EEEEEE;">
																<span style="background-image: url(/images/1111.png);margin-left: 15px;width: 60px;height: 72px;line-height: 65px;text-align: center;color: #212121;"><i>签约</i></span>
																<?php if($clres['mues'] == 1){?><span style="margin-left: 15px;width: 690px;height: 72px;color: #546E7A;">
																...
																<span class="layui-progress-text"><?php echo $mues_arr['transferIn']?> = <?php echo $mues_arr['percent']?>%</span>
																</div>
																</div>
																温馨提示：分红结算时间为契约签定时间开始至结束为准，超时契约到期自动取消
																</span>
																<?php }else {?>
																<span style="margin-left: 15px;width: 690px;height: 72px;color: #546E7A;">
																未签约，周契约充值量需达到 <?php echo $res['mues']?> 元，达到后可领取分红<?php echo $res['ratio']?>% 即 <?php echo $res['mues']?> 乘 <?php echo $res['ratio']?>%
																 <div class="layui-progress layui-progress-big" lay-showpercent="true" style="background-color: #00BCD4;">
																<div class="layui-progress-bar" lay-percent="0%" style="width: 0%;">
																<span class="layui-progress-text">0%</span>
																</div>
																...
																<?php }?>
																<span style="display:inline-block;  margin-left: <?php if($clres['mues'] == 1){?>2.3%<?php }else {?>2.3%<?php }?>;  line-height: 4em;">
																	 <?php if($clres['mues'] == 1 && $mues_arr['percent'] < 100){?>
																	<a class="in-but-l w-16" href="javascript:;">已签约</a>
																	<?php } else if($clres['mues'] == 1 && $mues_arr['percent'] >= 100  &&  $mues_zufeData == true) {?> 
																	<a class="in-but-l w-16" href="javascript:;" onclick="drawshare('mues');">领取分红</a>
																	<?php } else if($mues_zufeData == false) {?>
																	<a class="in-but-l w-16" href="javascript:;" onclick="contractLog('mues',1);">契约已作废，请重新签订</a>
																	<?php } else {?>
																	<a class="in-but-l w-16" href="javascript:;" onclick="contractLog('mues',1);">未签约</a>
																	<?php }?>
																</span>
															...
															<dd style=" height: 80px;border: 1px solid #607D8B;width: 95%;margin-left: 15px;margin-top:15px;background-color:#EEEEEE;">
																<span style="background-image: url(/images/1111.png);margin-left: 15px;width: 60px;height: 72px;line-height: 65px;text-align: center;color: #212121;"><i>签约</i></span>
																<?php if($clres['yues'] == 1){?><span style="margin-left: 15px;width: 690px;height: 72px;color: #546E7A;">
																 您已签定月契约，充值需达 <?php echo $res['yues']?> 元，达到后可领取分红<?php echo $res['ratio']?>% 即 <?php echo $res['yues']?> 乘 <?php echo $res['ratio']?>%
																 <div class="layui-progress layui-progress-big" lay-showpercent="true" style="background-color: #4CAF50;">
																<div class="layui-progress-bar" lay-percent="<?php echo $yues_arr['percent']?>%" style="width: <?php echo $yues_arr['percent']?>%;">
																<span class="layui-progress-text"><?php echo $yues_arr['transferIn']?> = <?php echo $yues_arr['percent']?>%</span>
																</div>
																</div>
																温馨提示：分红结算时间为契约签定时间开始至结束为准，超时契约到期自动取消
																</span>
																<?php }else {?>
																<span style="margin-left: 15px;width: 690px;height: 72px;color: #546E7A;">
																 未签约，月契约量需达到 <?php echo $res['yues']?> 元，达到后可领取分红<?php echo $res['ratio']?>% 即 <?php echo $res['yues']?> 乘 <?php echo $res['ratio']?>%
																 <div class="layui-progress layui-progress-big" lay-showpercent="true" style="background-color: #00BCD4;">
																<div class="layui-progress-bar" lay-percent="0%" style="width: 0%;">
																<span class="layui-progress-text">0%</span>
																</div>
																...
																<?php }?>
																<span style="display:inline-block;  margin-left: <?php if($clres['yues'] == 1){?>2.3%<?php }else {?>2.3%<?php }?>;  line-height: 4em;">
																	 <?php if($clres['yues'] == 1 && $yues_arr['percent'] < 100){?>
																	<a class="in-but-l w-16" href="javascript:;">已签约</a>
																	<?php }  else if($clres['yues'] == 1 && $yues_arr['percent'] >= 100 &&  $yues_zufeData == true) {?> 
																	<a class="in-but-l w-16" href="javascript:;" onclick="drawshare('yues');">领取分红</a>
																	<?php }  else if($yues_zufeData == false) {?>
																	<a class="in-but-l w-16" href="javascript:;" onclick="contractLog('yues',1);">契约已作废，请重新签订</a>
																	<?php } else {?>
																	<a class="in-but-l w-16" href="javascript:;" onclick="contractLog('yues',1);">未签约</a>
																	<?php }?>
																</span>
															</dd>
														</dl>
														...
														<!--<div class="tianjzh">
															<a class="in-but-l w-16" href="javascript:;" onclick="contractLog();">签定契约</a>
														</div>-->
													</div>
												</div>
												<div class="tb-imte" style="display: none;">
