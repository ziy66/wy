...
<span style="text-align: center;margin-left: 88%;margin-top: -76px;cursor: pointer;border: 3px solid #607D8B;border-radius: 2px 2px 2px 2px;color: #212121;" id="videoHead" data-class="show">开奖直播</span>
            <div class="j_lottery_time" servertime="" style="font-size: 38px; color: #000;">
				<div class="shij">
	...
	<div class="lottery_playContainer">
		...
		<div class="play_select_insert" id="j_play_select">
			<ul class="play_select_tit">
				<li lottery_code="5x" class="curr">五星玩法</li>	
				<li lottery_code="4x">四星玩法</li>
				<li lottery_code="q3">前三玩法</li>
				<li lottery_code="z3">中三玩法</li>
				<li lottery_code="h3">后三玩法</li>
				<li lottery_code="q2">前二玩法</li>
				<li lottery_code="h2">后二玩法</li>
				<li lottery_code="1x">定位玩法</li>
				<li lottery_code="dsds">大小单双</li>
				<li lottery_code="dsds">龙虎玩法</li> 
    ...
    <section id="gameBet" class="cl">
		<section class="gameBet_balls">
			...
			<if condition="$nowcpinfo['iswh'] eq 0">
				...
				<div class="g_Number_Section" style="width: 935px;padding: 15px 0;">
				...
				<div class="xiad-righ">
					<ul>
						<li class="li22"><span id="f_submit_order" style="background: linear-gradient(135deg,#deabc7 0%,#81abe4);">
							<img src="__ROOT__/resources/images/icon/icon_06.png">&nbsp;&nbsp;确认投注</span>
						</li>
						
						
						&nbsp;&nbsp;<li class="li22"><span style="background: linear-gradient(135deg,#ff5722 0%,#FF5722);">
							<button class="addtobetbtn" type="button">&nbsp;&nbsp;添加订单</span>
						</li>
						
						
						<li class="li22 li23"style="background: linear-gradient(135deg,#91abdf 0%,#d6abca);><span id="orderlist_clear" style="cursor: pointer;">
        ...
        <div class="gameBet_right">
			...
			<div class="title">
                    <span class="fl">中奖信息</span>
                    <span class="fr">
                    <a target="_blank" class="open_lotteryNumb_chart yopen_explain"  href="{:U('Trend/trend_ssc',array('code'=>$nowcpinfo['name']))}">开奖走势</a>
                    |
                    <a href="javascript:void(0);" class="yopen_explain helps">玩法帮助</a>
