...
<link rel="stylesheet" href="__CSS2__/ssc1.css">
...
<style>	
    ...
    background: linear-gradient(#212121,#212121,#212121,#212121,#212121,#212121,#212121,#ffffff,#212121,#212121,#212121,#212121,#212121,#212121);
	}
</style>
...
<section class="container wapper" id="gamepage" style="width:1300px!important;">
	<div class="open_containers g_Time_Section">
        ...
        <div class="cz_logo">
            ...
            <h4 class="logo"><img src="/image/ssc.png"></h4>    
            </a>
        </div>
        <!--彩种logo-->
        <!--彩种开奖倒计时-->
...
<span style="text-align: center;margin-left: 88%;margin-top: -76px;cursor: pointer;border: 3px solid #607D8B;border-radius: 2px 2px 2px 2px;color: #212121;" id="videoHead" data-class="show">开奖直播</span>
        ...
        <div class="cz_openNumb">
            ...
            <div class="open_issue">本期第&nbsp;&nbsp;<b class="c_red" way-data="showExpect.lastFullExpect" id="f_lottery_info_lastnumber" firstissueno="">---</b>&nbsp;&nbsp;开奖号码</div>
  ...
  $("#videoHead").click(function(){
    ...
    height: 33px;
    margin-left: 35px;
    background-image: linear-gradient(45deg, #ffffff 25%, white 25%, transparent 60%, #f6f6f6 75%, #dddddd 100%),linear-gradient(45deg, #68cae0 25%, #62b4e8 100%, #67b2e9 75%, #69c1e2 75%, #69cfdf 100%);
">
					<ul>
						<a href="/OldGame.ssc?code=xjssc">
							<li class="curr">官方玩法</li>
							<li class="router-link-exact-active ">信用玩法</li>
						</a>
					</ul>
				</div>
    ...
    <section id="gameBet" class="cl">
		<section class="gameBet_balls gameBet_ballsct">
			...
			<if condition="$nowcpinfo['iswh'] eq 0">
				...
				<!--玩法二级选项结束-->
				<!--玩法详细说明区域-->
				<div class="play_select_prompt play_select_prompts" style="padding:-px 0;">
					...
					<div class="bar-bet">
						<div class="fromList">
							<div class="checkbox pull-left bet-add ">
								...
								<button type="button" class="btn btn-danger fl bet-add commitbtn btn-tj">确认投注</button>
						</div>
						<div class="foot-top fl" style="display: block;">
							<ul>
								...
								<li class="cm6"><span>2000</span></li>
								<li class="cm7"><span>3000</span></li>
								<li class="cm8"><span>5000</span></li>
								<li class="cm9"><span>8000</span></li>
								<li class="cm10"><span>10000</span></li>
							</ul>
						</div>
...
<script type="text/template" data-nav='整合'>
		...
		<div class="s1_nav clearfix">
            <ul class="clear zhqk" data-title="总和">
                
            </ul>
        </div>
        <div class="s1_nav clearfix">
            <ul class="clear">
                <li class="" data-title="第一球">   
                </li>
                <li class="" data-title="第二球">
                </li>
                <li class="" data-title="第三球">
                </li>
                <li class="" data-title="第四球">
                </li>
                <li class="" data-title="第五球">	  
                </li>
        ...
        <div class="s1_nav">
            <div class="nav_wanfa">
                <div class="zm16_nav nav-tab fl active">前三</div>
                <div class="zm16_nav nav-tab fl">中三</div>
                <div class="zm16_nav nav-tab fl">后三</div>
            </div>
            <div id="qzhList">
                <div>
                    <ul data-title="前三"></ul>
    ...
    <script type="text/template" data-nav='全5中1'>
    	<div class="g_Number_Section_sliderbox sliderbox">
			<span class="buyNumberTitle">投注返点<i ></i></span>
			<div class="progressTime"  style="width:auto;">
    ...
    <script type="text/template" data-nav='龙虎斗'>
    	<div class="g_Number_Section_sliderbox sliderbox">
			<span class="buyNumberTitle">投注返点<i ></i></span>
			<div class="progressTime"  style="width:auto;">
        ...
        <div class="toradora toradora_bar clear">
            <ul class="clear_fix tc fl ball0-0">
                <li  class="wid1">
                    <div class="t-head">
                        <b>万千 </b><label>第一球VS第二球</label>
                    </div>
                    <div class="t-box" data-title="万千">
                        
                    </div>
                </li>
                <li  class="wid1">
                    <div class="t-head">
                        <b>万百 </b><label>第一球VS第三球</label>
                    </div>
                    <div class="t-box" data-title="万百">
                        
                    </div>
                </li>
                <li  class="wid1">
                    <div class="t-head">
                        <b>万十 </b><label>第一球VS第四球</label>
                    </div>
                    <div class="t-box" data-title="万十">
                        
                    </div>
                </li>
                <li  class="wid1">
                    <div class="t-head">
                        <b>万个 </b><label>第一球VS第五球</label>
                    </div>
                    <div class="t-box" data-title="万个">
                        
                    </div>
                </li>
            </ul>
            <ul class="clear_fix tc fl ball0-1">
                <li  class="wid1">
                    <div class="t-head">
                        <b>千百 </b><label>第二球VS第三球</label>
                    </div>
                    <div class="t-box" data-title="千百">
                        
                    </div>
                </li>
                <li  class="wid1">
                    <div class="t-head">
                        <b>千十 </b><label>第二球VS第四球</label>
                    </div>
                    <div class="t-box" data-title="千十">
                        
                    </div>
                </li>
                <li  class="wid1">
                    <div class="t-head">
                        <b>千个 </b><label>第二球VS第五球</label>
                    </div>
                    <div class="t-box" data-title="千个">
                        
                </li>
            </ul>
            <ul class="clear_fix tc fl ball0-2">
                <li  class="wid1">
                    <div class="t-head">
                        <b>百十 </b><label>第三球VS第四球</label>
                    </div>
                    <div class="t-box" data-title="百十">
                        
                </li>
                <li  class="wid1">
                    <div class="t-head">
                        <b>百个 </b><label>第三球VS第五球</label>
                    </div>
                    <div class="t-box" data-title="百个">
                        
                    </div>
                </li>
                
            </ul>
            <ul class="clear_fix tc fl ball0-3">
                <li  class="wid1">
                    <div class="t-head">
                        <b>十个 </b><label>第四球VS第五球</label>
                    </div>
                    <div class="t-box" data-title="十个">
...
<script>
	var gameaj=new games('0','整合');
        gameaj.type='sscList';
        var url='/apijiekou.getOldPlay?typeid=ssc';
        gameaj.getList(url,gameaj.sscList.整合);
