$(function () {
    ...
    tabGameInit();
    $('.changeBtn').find('a').attr('href','/OldGame.ssc?code='+lotteryname);
    // function tabGameInits(){
    //   _thisPlayid = 'wxzhixfs';
    //   rates = yrates[_thisPlayid];
    //   gameSwitch($('.bet_filter_box'),ssc_ctzh_title,ssc_ctzh_arr);
    //   $('.play_select_prompt').find('span[way-data="tabDoc"]')
    //         .html('每位至少选择一个号码，竞猜开奖号码的全部五位，号码和位置都对应即中奖，奖金 <em style="color:red;">'+rates.maxjj+'</em>元');
    //   gameNumber(wx_fs);
    ...
    function countFun(){
        switch(_thisPlayid){
            ...
            case 'bdw5x3m':
                ...
                break;
            case 'qwyffs': case 'qwhscs': case 'qwsxbx': case 'qwsjfc':
            zhushus.length = currNumber[0].length;
            break;
            case 'sixzhixfsh':
                zhushus = combination(currNumber);
            ...
            case 'bdw4x2m':
                zhushus = combine(currNumber[0],2);
                break;
            case 'sxzhixfsq': case 'sxzhixfsz': case 'sxzhixfsh':
            zhushus = combination(currNumber);
            break;
            case 'zhixhzqs': case 'zhixhzzs': case 'zhixhzhs':
            zhushus.length = qszxhzCombine();
            break;
            case 'kuaduqs': case 'kuaduzs': case 'kuaduhs':
            zhushus.length = qskdCombine();
            break;
            case 'zuxhzqs': case 'zuxhzzs': case 'zuxhzhs':
            zhushus.length = qszuxhzCombine();
            break;
            case 'sxzuxzsq': case 'sxzuxzsz': case 'sxzuxzsh':
            zhushus.length = currNumber[0].length * (currNumber[0].length - 1);
            break;
            case 'sxzuxzlq': case 'sxzuxzlz': case 'sxzuxzlh':
            zhushus = combine(currNumber[0],3);
            break;
            case 'zuxcsbd': case 'zuxzsbd': case 'zuxhsbd':
            zhushus.length = 54;
            break;
            case 'bdwqs': case 'bdwzs': case 'bdwhs':
            zhushus.length = currNumber[0].length;
            break;
            case 'bdwqs2m': case 'bdwzs2m': case 'bdwhs2m':
            zhushus = combine(currNumber[0],2);
            break;
            case 'exzhixfsq': case 'exzhixfsh':
            zhushus = combination(currNumber);
            break;
            case 'zhixhzqe': case 'zhixhzhe':
            zhushus.length = hezxhz();
            break;
            case 'kuaduqe': case 'kuaduhe':
            zhushus.length = exkuadu();
            break;
            case 'exzuxfsq': case 'exzuxfsh':
            zhushus = combine(currNumber[0],2);
            break;
            case 'zuxhzqe': case 'zuxhzhe':
            zhushus.length = exzuxhz();
            break;
            case 'zuxcebd': case 'zuxhebd':
            zhushus.length = 9;
            break;
            case 'dweid':
                zhushus.length = $('.g_Number_Section').find('.curr').length;
                break;
            case 'dxdsqe': case 'dxdshe': case 'dxdsqs': case 'dxdshs':
            zhushus = combination(currNumber);
            break;
        }
    ...
    $('.bet_filter_box').on('click','.bet_options',function (){
        ...
        switch(_thisType){
            ...
            break;
            case 'sxzhixdsq': case 'sxzhixdsz': case 'sxzhixdsh':
            ...
            break;
            case 'sxhhzxq': case 'sxhhzxz': case 'sxhhzxh':
            ...
            if(_thisType == 'zuxcsbd'){
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('从0-9中任意选择1个包胆号码，开奖号码的前三位中任意1位与所选包胆号码相同(不含豹子号)，即为中奖，奖金 <em style="color:red;">'+rates.maxjj+'</em>元');
            }else if(_thisType == 'zuxzsbd'){
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('从0-9中任意选择1个包胆号码，开奖号码的中三位中任意1位与所选包胆号码相同(不含豹子号)，即为中奖，奖金  <em style="color:red;">'+rates.maxjj+'</em>元');
            }else if(_thisType == 'zuxhsbd'){
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('从0-9中任意选择1个包胆号码，开奖号码的后三位中任意1位与所选包胆号码相同(不含豹子号)，即为中奖，奖金 <em style="color:red;">'+rates.maxjj+'</em>元');
            }
            gameNumberZxbd(zuxcsbd);
            break;
            case 'qszsds': case 'zszsds': case 'hszsds':
            if(_thisType == 'qszsds'){
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
            ...
            danshiGame();
            break;
            case 'qszlds': case 'zszlds': case 'hszlds':
            if(_thisType == 'qszlds'){
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('手动输入号码，3个数字为一注，所选号码与开奖号码的前三位相同，顺序不限，奖金 <em style="color:red;">'+rates.maxjj+'</em>元');
    ...
    $('.addtobetbtn').on('click',function (){
        var yBetting = $('.selectMultipleCon');
        ...
        if(zhushus.length >= 1){
            ...
            yBetting.each(function (i) {
                ...
                if(gameNumber == Numbers && _thisRmb == selectRmbStr && gameNumberType == _thisType){
                    ...
                    winningMoneys = _thisTimes * winningMoney ;
                    winningMoneys = winningMoneys.toFixed(2);
                    console.log(winningMoneys);return'';
                    $(this).find('.yBettingTimess').text(_thisTimes);
                    $(this).find('.maxMoneyNumber').text(winningMoneys+'元');
                    $(this).find('#betting_money').text(zhushus.length * minMoney * _thisTimes );
                    orderList[i].beishu = _thisTimes;
                    orderList[i].price = zhushus.length * minMoney * _thisTimes ;
                }
            })
    ...
    $(document).on("click", "#f_submit_order", function() {
        ...
        //console.log(orderList);
        artDialog({
            title:"投注详情1<span style='margin-left:15px;'><img src='"+WebConfigs["ROOT"]+"/resources/images/icon/icon_09.png'>截至时间:<strong class='sty-h gametimes' style='font-weight:normal'>00:00:00</strong></span>",
    ...
    //传统玩法投注选中效果
    $('.selectOn').on('click',function(e){
        var mone=$('.form-control').val();
        if($(this).hasClass('hoverTr')){
            $(this).removeClass('hoverTr').addClass('check');
            $(this).find('.betMoney').val(mone);
            ...
            $(this).removeClass('check').addClass('hoverTr');
            $(this).find('.betMoney').val('');
        }
    })
    ...
    $('.form-control').on('keyup',function(){
        ...
        $('.check').find('input.betMoney').val(mone);
    })
    ...
    $('.fromList').find('.reset').on('click',function(){
        $('.check').addClass('hoverTr').find('.betMoney').val('').end().removeClass('check');
        $('.form-control').val('');
    })

    $('button.btn-tj').on('click',function(){
        var cunts=0;
        var mone=0;
        var html='';
        var lists=$('.contList').find('.check').size();
        $('.contList').find('.check').each(function(i){
            var value=$(this).find('.betMoney').val();
            if(value!=''&&value>0){
                var name=$(this).find('.betMoney').attr('data-n1');
                var rate=$(this).find('.betMoney').attr('data-rate');
                cunts++;
                html+='<div class="wrapOdds">'+
                    '<span>'+name+'</span>'+
                    '<span class="oddsRight">赔率 <var>'+rate+' X '+value+'</var></span>'+
                    '</div><div style="clear: both;"></div>';
                mone+=parseInt(value);
            }
        })
        if(cunts>0){
            $('.submitComfirebox #Orderdetaillist').html(html);
            $('#shade').show().siblings('.submitComfirebox').show();
            $(".submitComfirebox #Orderdetailtotalprice").text(mone);
        }else{
            alert("请选择投注号码");
        }

    })
    $('.icon-guanbi-copy,.cancel').on('click',function(){
        $(this).parents('.submitComfirebox').hide().siblings('#shade').hide();
    })
    //玩法切换
    $(document).on('click','#j_play_select li',function () {
        var className=$(this).attr('class');
        if($(this).hasClass('nopaly')){
            return;
        }
        var this_attr = $(this).attr('lottery_code');
        $(this).addClass('curr').siblings('li').removeClass('curr');
        $('.g_Number_Section').html('');
        attrLottery(this_attr)
        addAndSubtract();
    })
    $(document).on('click','#j_play_select .nopaly a',function () {
        var name=$(this).text();
        var this_attr = $(this).attr('lottery_code');
        $(this).parents('.moreNav').siblings('#moreMethod').text(name);
        $(this).parents('.moreNav').hide();
        $(this).parents('.nopaly').addClass('curr').siblings('li').removeClass('curr');
        attrLottery(this_attr)
        addAndSubtract();
    })
    $('.nopaly').on('hover',function(){
        $(this).children('.moreNav').show();
    },function(){
        $(this).children('.moreNav').hide();
    })
    $('.nopaly').hover(function(){
        $(this).children('.moreNav').show();
    },function(){
        $(this).children('.moreNav').hide();
    })
    function attrLottery(this_attr){
        switch(this_attr){
            case '5x':
                $('#bet_filter').remove();
                gameSwitch($('.bet_filter_box'),ssc_5x_title,ssc_5x_arr);
            ...
            case 'ctzh'://传统玩法开始
                ...
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('可自行选取0～9或双面投注项目来进行投注，其开奖结果的万仟百拾个位数与投注项目相同即为中奖龙、虎、和为万位与个位的数字组合大小比对');

                break;
            case 'ctww'://传统玩法开始
                $('#bet_filter').remove();
                gameSwitch($('.bet_filter_box'),ssc_ctww_title,ssc_ctww_arr);
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('可自行选取0～9或双面投注项目来进行投注，其开奖结果的万位数与投注项目相同即为中奖龙、虎、和为万位与个位的数字组合大小比对');
                break;
            case 'ctqw'://传统玩法开始
                $('#bet_filter').remove();
                gameSwitch($('.bet_filter_box'),ssc_ctqw_title,ssc_ctqw_arr);
                _thisPlayid = 'dxdsqe';
                rates = yrates[_thisPlayid];
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('从万位、千位中的“大、小、单、双”中至少各选一个组成一注，奖金 <em style="color:red;">'+rates.maxjj+'</em>元');
            ...
            case 'ctbw'://传统玩法开始
                $('#bet_filter').remove();
                gameSwitch($('.bet_filter_box'),ssc_ctbw_title,ssc_ctbw_arr);
                _thisPlayid = 'dxdsqe';
                rates = yrates[_thisPlayid];
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('从万位、千位中的“大、小、单、双”中至少各选一个组成一注，奖金 <em style="color:red;">'+rates.maxjj+'</em>元');
            ...
            case 'ctsw'://传统玩法开始
                $('#bet_filter').remove();
                gameSwitch($('.bet_filter_box'),ssc_ctsw_title,ssc_ctsw_arr);
                _thisPlayid = 'dxdsqe';
                rates = yrates[_thisPlayid];
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('从万位、千位中的“大、小、单、双”中至少各选一个组成一注，奖金 <em style="color:red;">'+rates.maxjj+'</em>元');
            ...
            case 'ctgw'://传统玩法开始
                $('#bet_filter').remove();
                gameSwitch($('.bet_filter_box'),ssc_ctgw_title,ssc_ctgw_arr);
                _thisPlayid = 'dxdsqe';
                rates = yrates[_thisPlayid];
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('从万位、千位中的“大、小、单、双”中至少各选一个组成一注，奖金 <em style="color:red;">'+rates.maxjj+'</em>元');
            ...
            case 'ctwsh'://传统玩法开始
                $('#bet_filter').remove();
                gameSwitch($('.bet_filter_box'),ssc_ctwsh_title,ssc_ctwsh_arr);
                _thisPlayid = 'dxdsqe';
                rates = yrates[_thisPlayid];
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('从万位、千位中的“大、小、单、双”中至少各选一个组成一注，奖金 <em style="color:red;">'+rates.maxjj+'</em>元');
            ...
            case 'ctlhd'://传统玩法开始
                $('#bet_filter').remove();
                gameSwitch($('.bet_filter_box'),ssc_ctlhd_title,ssc_ctlhd_arr);
                _thisPlayid = 'dxdsqe';
                rates = yrates[_thisPlayid];
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('从万位、千位中的“大、小、单、双”中至少各选一个组成一注，奖金 <em style="color:red;">'+rates.maxjj+'</em>元');
            ...
            case 'ctqp'://传统玩法开始
                $('#bet_filter').remove();
                gameSwitch($('.bet_filter_box'),ssc_ctqp_title,ssc_ctqp_arr);
                _thisPlayid = 'dxdsqe';
                rates = yrates[_thisPlayid];
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('从万位、千位中的“大、小、单、双”中至少各选一个组成一注，奖金 <em style="color:red;">'+rates.maxjj+'</em>元');
            ...
            case 'cths'://传统玩法开始
                $('#bet_filter').remove();
                gameSwitch($('.bet_filter_box'),ssc_cths_title,ssc_cths_arr);
                _thisPlayid = 'dxdsqe';
                rates = yrates[_thisPlayid];
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('从万位、千位中的“大、小、单、双”中至少各选一个组成一注，奖金 <em style="color:red;">'+rates.maxjj+'</em>元');
            ...
            case 'ctzs'://传统玩法开始
                $('#bet_filter').remove();
                gameSwitch($('.bet_filter_box'),ssc_ctzs_title,ssc_ctzs_arr);
                _thisPlayid = 'dxdsqe';
                rates = yrates[_thisPlayid];
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('从万位、千位中的“大、小、单、双”中至少各选一个组成一注，奖金 <em style="color:red;">'+rates.maxjj+'</em>元');
            ...
            case 'ctzl'://传统玩法开始
                $('#bet_filter').remove();
                gameSwitch($('.bet_filter_box'),ssc_ctzl_title,ssc_ctzl_arr);
                _thisPlayid = 'dxdsqe';
                rates = yrates[_thisPlayid];
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('从万位、千位中的“大、小、单、双”中至少各选一个组成一注，奖金 <em style="color:red;">'+rates.maxjj+'</em>元');
            ...
            case 'ctkd'://传统玩法开始
                $('#bet_filter').remove();
                gameSwitch($('.bet_filter_box'),ssc_ctkd_title,ssc_ctkd_arr);
                _thisPlayid = 'dxdsqe';
                rates = yrates[_thisPlayid];
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('从万位、千位中的“大、小、单、双”中至少各选一个组成一注，奖金 <em style="color:red;">'+rates.maxjj+'</em>元');
            ...
            case 'ctyz'://传统玩法开始
                $('#bet_filter').remove();
                gameSwitch($('.bet_filter_box'),ssc_ctyz_title,ssc_ctyz_arr);
                _thisPlayid = 'dxdsqe';
                rates = yrates[_thisPlayid];
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('从万位、千位中的“大、小、单、双”中至少各选一个组成一注，奖金 <em style="color:red;">'+rates.maxjj+'</em>元');
            ...
            case 'ctez'://传统玩法开始
                $('#bet_filter').remove();
                gameSwitch($('.bet_filter_box'),ssc_ctez_title,ssc_ctez_arr);
                _thisPlayid = 'dxdsqe';
                rates = yrates[_thisPlayid];
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('从万位、千位中的“大、小、单、双”中至少各选一个组成一注，奖金 <em style="color:red;">'+rates.maxjj+'</em>元');
            ...
            case 'ctsz'://传统玩法开始
                $('#bet_filter').remove();
                gameSwitch($('.bet_filter_box'),ssc_ctsz_title,ssc_ctsz_arr);
                _thisPlayid = 'dxdsqe';
                rates = yrates[_thisPlayid];
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('从万位、千位中的“大、小、单、双”中至少各选一个组成一注，奖金 <em style="color:red;">'+rates.maxjj+'</em>元');
            ...
            case 'ctezdw'://传统玩法开始
                $('#bet_filter').remove();
                gameSwitch($('.bet_filter_box'),ssc_ctezdw_title,ssc_ctezdw_arr);
                _thisPlayid = 'dxdsqe';
                rates = yrates[_thisPlayid];
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('从万位、千位中的“大、小、单、双”中至少各选一个组成一注，奖金 <em style="color:red;">'+rates.maxjj+'</em>元');
            ...
            case 'ctszdw'://传统玩法开始
                $('#bet_filter').remove();
                gameSwitch($('.bet_filter_box'),ssc_ctszdw_title,ssc_ctszdw_arr);
                _thisPlayid = 'dxdsqe';
                rates = yrates[_thisPlayid];
                $('.play_select_prompt').find('span[way-data="tabDoc"]')
                    .html('从万位、千位中的“大、小、单、双”中至少各选一个组成一注，奖金 <em style="color:red;">'+rates.maxjj+'</em>元');
