	...
	<div class="accordion" style="display:none" id="accordion-zhibao">
		<dl>
			...
			<dd class="accordion-content accordionItem is-collapsed" id="accordion1" aria-hidden="true">
				...
				<p><iframe src="<?php echo $cpRes['zhibao_url']?>"  scrolling="no"  frameborder="0" style="width: 100%; height: 830px;"></iframe></p>
			</dd>
		</dl>
	</div>
		<?php } else {?>
    ...
    <section id="gameBet" class="cl">
		<section class="gameBet_balls gameBet_ballsct">
			...
			<if condition="$nowcpinfo['iswh'] eq 0">
				...
				<!--玩法二级选项结束-->
				<!--玩法详细说明区域-->
				<div class="play_select_prompt play_select_prompts" style="padding:0px 0;">
