...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>{$cptitle}开奖走势图 - {:GetVar('webtitle')}-线上官网</title>
...
<table class="dataTable" id="chartsTable">
    <thead>
        <tr class="text-c">
            ...
            <th colspan="11">第一位</th>
            <th colspan="11">第二位</th>
            <th colspan="11">第三位</th>
            <th colspan="11">第四位</th>
            <th colspan="11">第五位</th>
        ...
        <tr>
          ...
          <th width="20"  height="20">10</th>
          <th width="20"  height="20">11</th>
