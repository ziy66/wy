...
<section class="container wapper" id="gamepage" style="width:1300px!important;">
	<div class="open_containers g_Time_Section">
        ...
        <div class="cz_logo">
            ...
            <h4 class="logo"><img src="/image/lhc.png"></h4>    
            </a>
        </div>
        <!--彩种logo-->
        <!--彩种开奖倒计时-->
        ...
        <div class="gameBet_right">
            ...
            <div class="right_infsoBlock">
                <div class="title">
                    ...
                    <span class="fr">
                    <a target="_blank" class="open_lotteryNumb_chart yopen_explain"  href="{:U('Trend/trend_lhc',array('code'=>$nowcpinfo['name']))}">走势图</a>
                    |
