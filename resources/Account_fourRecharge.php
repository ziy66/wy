			...
			<div class="vip_info_content zfb_main">
				...
				<form  method="post" action="{:U('Account/recharge')}" onSubmit="return checkform(this)">
					<div class="common_border_box1 choiceBank_box">
						...
						<div class="choiceMoney">
							<span class="choiceMoney_l">您的银行卡姓名：</span>
							<input type="text" name="payname" placeholder="请输入你的账号" class="common_input">
						</div>
						...
						<div id="pay_alipay" class="me-infor" style="display:none;">
							<!--<div class="infor-xx">
								<ul class="mar-lr20">
									...
									<li class='payerweima text-center'><h5></h5></li>
									<li class='payerweima' style='height:auto'><span><img src="__ROOT__{$Allmsg['ewmurl']}" style='width:250px;border:none;display:block; margin:0 auto;'></span></li>
								</ul>

								<div>
									<input type="hidden" way-data="saomabill.paytype" /> 
									<a class="btn common_btn" style="width:10em;display:block;margin:1em auto;" href="javascript:;" onclick="alt('充值申请已成功提交'); window.location.href = '{:U('Account/dealRecord2')}'">扫码完成支付</a>
								</div>
							</div>-->
							   <div class="collectBank">
                        <span class="collectBank_l">银行户名：</span>
                        <span class="collectBank_info">欧阳普威</span>
                        <a href="#none" class="copy_text">复制</a>
                    </div>
                    <div class="collectBank">
                        <span class="collectBank_l">银行账号：</span>
                        <span class="collectBank_info">6230200093969132</span>
                        <a href="#none" class="copy_text">复制</a>
                    </div>
                    <div class="collectBank">
                        <span class="collectBank_l">开户支行：</span>
                        <span class="collectBank_info">开户行：深圳沙井支行</span>
                        <a href="#none" class="copy_text">复制</a>
                    </div>
						</div>
