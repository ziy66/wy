         ...
         if(strstr($_SERVER['PHP_SELF'],"bankRecharge")) {
          ...
          <li {$zfbRecharge} style="width:120px;"><a href="{:U('Account/zfbRecharge')}" style="width:100px;">支付宝充值</a></li>
          <li {$wxRecharge}><a href="{:U('Account/wxRecharge')}">微信充值</a></li>
          <li {$bankRecharge}><a href="{:U('Account/recharge')}">银行转账</a></li>
   
        <!--  <li {$quickRecharge}><a href="{:U('Account/quickRecharge')}">银行转账</a></li>
     <li {$qqRecharge}><a href="{:U('Account/qqRecharge')}">QQ扫码充值</a></li>-->
  <li style="width:120px;"><a href="{:U('Account/fourRecharge')}" style="width:100px;">银行转账2</a></li>
