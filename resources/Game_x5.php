...
<link rel="stylesheet" href="__CSS2__/ssc3.css">
...
<script type="text/javascript" src="__ROOT__/resources/main/syxw.js"></script>
<script type="text/javascript" src="__ROOT__/resources/js2/syxwtabGame.js"></script>
...
<section class="container wapper" id="gamepage" style="width:1300px!important;">
	<div class="open_containers g_Time_Section">
        ...
        <div class="cz_logo">
            ...
            <h4 class="logo"><img src="/image/11x5.png"></h4>    
            </a>
        </div>
        <!--彩种logo-->
        <!--彩种开奖倒计时-->
	...
	<div class="lottery_playContainer">
		...
		<div class="play_select_insert" id="j_play_select">
			<ul class="play_select_tit">
			    <li lottery_code="">五码玩法</li>
			    <li lottery_code="">四码玩法</li>
				<li lottery_code="sm" class="curr">三码玩法</li>	
				<li lottery_code="em">二码玩法</li>
				<li lottery_code="bdw">不定胆玩法</li>
				<li lottery_code="dwd">定位胆玩法</li>
				<li lottery_code="qw">趣味玩法</li>
        ...
        <div class="gameBet_right">
            ...
            <div class="right_infsoBlock">
                <div class="title">
                    ...
                    <span class="fr">
                    <a target="_blank" class="open_lotteryNumb_chart yopen_explain"  href="{:U('Trend/trend_x5',array('code'=>$nowcpinfo['name']))}">走势图</a>
                    |
            ...
            <div class="least_luckMember">
                ...
                <div class="ranking_scroll_box" style="height:380px;">
