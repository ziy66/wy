...
<script type="text/javascript" src="__ROOT__/resources/main/kl8.js"></script>
<script type="text/javascript" src="__ROOT__/resources/js2/kl8tabGame.js"></script>
...
<section class="container wapper" id="gamepage" style="width:1300px!important;">
	<div class="open_containers g_Time_Section">
        <!--彩种logo-->
        <div class="cz_logo">
            <h2 class="lottery_title_h2" way-data="showLotteryTitle.name">---</h2>
            <a href="javascript:void(0)" >
            <h4 class="logo"><img src="/image/kl8.png"></h4>    
            </a>
        </div>
        <!--彩种logo-->
        <!--彩种开奖倒计时-->
        <div class="cz_daojishi">
            <div class="open_issue">距离第&nbsp;&nbsp;
				<b class="c_red" id="f_lottery_info_number" way-data="showExpect.currFullExpect">---</b>&nbsp;&nbsp;期封盘倒计时
			</div>
			<span style="text-align: center;margin-left: 88%;margin-top: -76px;cursor: pointer;border: 3px solid #607D8B;border-radius: 2px 2px 2px 2px;color: #212121;" id="videoHead" data-class="show">开奖直播</span>
        ...
        <div class="cz_openNumb">
            ...
            <div class="open_number">
                ...
                <ol id="ssc_winning_sum" style="padding: 0 7px;">
				
				    <li class="kl8_winning_sum_gif" style="width: 45px;height: 45px;margin: 0px 1px;font-size: 25px;line-height: 45px;text-indent: 1px;" way-data="showExpect.openCode1"></li>
				
				
					<li class="kl8_winning_sum_gif" style="width: 45px;height: 45px;margin: 0px 1px;font-size: 25px;line-height: 45px;text-indent: 1px;" way-data="showExpect.openCode2"></li>
                    <li class="kl8_winning_sum_gif" style="width: 45px;height: 45px;margin: 0px 1px;font-size: 25px;line-height: 45px;text-indent: 1px;" way-data="showExpect.openCode3"></li>
                    <li class="kl8_winning_sum_gif" style="width: 45px;height: 45px;margin: 0px 1px;font-size: 25px;line-height: 45px;text-indent: 1px;" way-data="showExpect.openCode4"></li>
                    <li class="kl8_winning_sum_gif" style="width: 45px;height: 45px;margin: 0px 1px;font-size: 25px;line-height: 45px;text-indent: 1px;" way-data="showExpect.openCode5"></li>
                    <li class="kl8_winning_sum_gif" style="width: 45px;height: 45px;margin: 0px 1px;font-size: 25px;line-height: 45px;text-indent: 1px;" way-data="showExpect.openCode6"></li>
					<li class="kl8_winning_sum_gif" style="width: 45px;height: 45px;margin: 0px 1px;font-size: 25px;line-height: 45px;text-indent: 1px;" way-data="showExpect.openCode7"></li>
                    <li class="kl8_winning_sum_gif" style="width: 45px;height: 45px;margin: 0px 1px;font-size: 25px;line-height: 45px;text-indent: 1px;" way-data="showExpect.openCode8"></li>
                    <li class="kl8_winning_sum_gif" style="width: 45px;height: 45px;margin: 0px 1px;font-size: 25px;line-height: 45px;text-indent: 1px;" way-data="showExpect.openCode9"></li>
                    <li class="kl8_winning_sum_gif" style="width: 45px;height: 45px;margin: 0px 1px;font-size: 25px;line-height: 45px;text-indent: 1px;" way-data="showExpect.openCode10"></li>
                    <li class="kl8_winning_sum_gif" style="width: 45px;height: 45px;margin: 0px 1px;font-size: 25px;line-height: 45px;text-indent: 1px;" way-data="showExpect.openCode11"></li>
					<li class="kl8_winning_sum_gif" style="width: 45px;height: 45px;margin: 0px 1px;font-size: 25px;line-height: 45px;text-indent: 1px;" way-data="showExpect.openCode12"></li>
                    <li class="kl8_winning_sum_gif" style="width: 45px;height: 45px;margin: 0px 1px;font-size: 25px;line-height: 45px;text-indent: 1px;" way-data="showExpect.openCode13"></li>
                    <li class="kl8_winning_sum_gif" style="width: 45px;height: 45px;margin: 0px 1px;font-size: 25px;line-height: 45px;text-indent: 1px;" way-data="showExpect.openCode14"></li>
                    <li class="kl8_winning_sum_gif" style="width: 45px;height: 45px;margin: 0px 1px;font-size: 25px;line-height: 45px;text-indent: 1px;" way-data="showExpect.openCode15"></li>
                    <li class="kl8_winning_sum_gif" style="width: 45px;height: 45px;margin: 0px 1px;font-size: 25px;line-height: 45px;text-indent: 1px;" way-data="showExpect.openCode16"></li>
					<li class="kl8_winning_sum_gif" style="width: 45px;height: 45px;margin: 0px 1px;font-size: 25px;line-height: 45px;text-indent: 1px;" way-data="showExpect.openCode17"></li>
                    <li class="kl8_winning_sum_gif" style="width: 45px;height: 45px;margin: 0px 1px;font-size: 25px;line-height: 45px;text-indent: 1px;" way-data="showExpect.openCode18"></li>
                    <li class="kl8_winning_sum_gif" style="width: 45px;height: 45px;margin: 0px 1px;font-size: 25px;line-height: 45px;text-indent: 1px;" way-data="showExpect.openCode19"></li>
                    <li class="kl8_winning_sum_gif" style="width: 45px;height: 45px;margin: 0px 1px;font-size: 25px;line-height: 45px;text-indent: 1px;" way-data="showExpect.openCode20"></li>
  ...
  $("#videoHead").click(function(){
	  ...
	  if( dataCalse == "show"){
		...
		if($cpRes['zhibao_url']) {?>
	<div class="accordion" style="display:none" id="accordion-zhibao">
		<dl>
			<dt>
			...
			<dd class="accordion-content accordionItem is-collapsed" id="accordion1" aria-hidden="true">
				...
				<p><iframe src="<?php echo $cpRes['zhibao_url']?>"  scrolling="no"  frameborder="0" style="width: 100%; height: 600px;"></iframe></p>
			</dd>
		</dl>
	</div>
		<?php } else {?>
    ...
    <section id="gameBet" class="cl">
		<section class="gameBet_balls">
			...
			<if condition="$nowcpinfo['iswh'] eq 0">
				...
				<div class="g_Number_Section" style="width: 1000px;padding: 15px 0;">
				</div>
				...
				<div class="xiad-righ">
					<ul>
						...
						&nbsp;&nbsp;<li class="li22">
							<button class="addtobetbtn" type="button">&nbsp;&nbsp;添加订单</span>
						</li>
						
						
						<li class="li22 li23"><span id="orderlist_clear" style="cursor: pointer;">
							<img src="__ROOT__/resources/images/icon/icon_19.png">&nbsp;&nbsp;订单清零</span>
						</li>
					</ul>
				</div>
				<div class="xiad-left">
				...
				<div class="g_Chase_Section">
					<div class="chase_Program">
						<p class="p_chase">当前您的选购方案注数
							<i class="c_green fw_600" way-data="ytotal_money_zhushu" id="f_gameOrder_lotterys_num">0</i> 注， 
							订单金额 <i class="c_org fw_600">¥<em id="f_gameOrder_amount" way-data="ytotal_money">0</em></i> 元  
						</p>
					</div>
				</div>   
        ...
        <div class="gameBet_right" style="margin-top: -35px;">
            ...
            <div class="right_infsoBlock">
                <div class="title">
                    ...
                    <span class="fr">
                    <a target="_blank" class="open_lotteryNumb_chart yopen_explain"  href="{:U('Trend/trend_keno',array('code'=>$nowcpinfo['name']))}">走势图</a>
                    |
            ...
            <div class="least_luckMember">
                ...
                <div class="ranking_scroll_box" style="height:535px;">
