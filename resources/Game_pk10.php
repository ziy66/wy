...
<style>	
	.j_lottery_time .shij span{
		style="font-size: 45px; color: #000;
	    color: #fd4747;
    /*font-size: 50px; */
        /* background-image: url(assets/bg66.png); */
    width: 58px;
    height: 22px;
    text-align: center;
    position: relative;
...
<section class="container wapper" id="gamepage" style="width:1300px!important;">
	<div class="open_containers g_Time_Section">
        ...
        <div class="cz_logo">
            ...
            <h4 class="logo"><img src="/image/pk10.png"></h4>    
            </a>
        </div>
        <!--彩种logo-->
        <!--彩种开奖倒计时-->
        ...
        <div class="cz_openNumb">
            ...
            <div class="open_number">
                ...
                <ol id="ssc_winning_sum" style="padding:0 15px;">
					<li class="bjpks_winning_sum_gif" style="width:40px;height:40px;" way-data="showExpect.openCode1"></li>
                    <li class="bjpks_winning_sum_gif" style="width:40px;height:40px;" way-data="showExpect.openCode2"></li>
                    <li class="bjpks_winning_sum_gif" style="width:40px;height:40px;" way-data="showExpect.openCode3"></li>
                    <li class="bjpks_winning_sum_gif" style="width:40px;height:40px;" way-data="showExpect.openCode4"></li>
                    <li class="bjpks_winning_sum_gif" style="width:40px;height:40px;" way-data="showExpect.openCode5"></li>
					<li class="bjpks_winning_sum_gif" style="width:40px;height:40px;" way-data="showExpect.openCode6"></li>
                    <li class="bjpks_winning_sum_gif" style="width:40px;height:40px;" way-data="showExpect.openCode7"></li>
                    <li class="bjpks_winning_sum_gif" style="width:40px;height:40px;" way-data="showExpect.openCode8"></li>
                    <li class="bjpks_winning_sum_gif" style="width:40px;height:40px;" way-data="showExpect.openCode9"></li>
                    <li class="bjpks_winning_sum_gif" style="width:40px;height:40px;" way-data="showExpect.openCode10"></li>
				</ol>
            </div>
...
">
					<ul>
						<a href="/OldGame.pk10?code=cqssc">
							<li class="router-link-exact-active curr">官方玩法</li>
							<li class="">信用玩法</li>
						</a>
					</ul>
				</div>
		...
		if($cpRes['zhibao_url']) {?>
	<div class="accordion" style="display:none; width:1180px" id="accordion-zhibao">
		<dl>
			<dt>
			...
			<dd class="accordion-content accordionItem is-collapsed" id="accordion1" aria-hidden="true">
				...
				<p><iframe src="<?php echo $cpRes['zhibao_url']?>"  scrolling="no"  frameborder="0" width="100%" scrolling="no" height="100%" frameborder="0" style="width: 100%; height: 855.652px;"></iframe></p>
			</dd>
		</dl>
	</div>
		<?php } else {?>
			...
			<ul class="system_lottery" style="width: 1506px;">
				...
				<volist name="ssclist" id="vo">
					<li <if condition="$vo['name'] eq $lotteryname">class="curr"</if> lotteryname="{$vo.name}">
						<a href="__ROOT__/Game.pk10?code={$vo.name}">{$vo.title}</a>
					</li>
				</volist>	
			</ul>
			<span class="next">
        ...
        <div class="gameBet_right" style="margin-top: -35px;">
            ...
            <div class="right_infsoBlock">
                <div class="title">
                    ...
                    <span class="fr">
                    <a target="_blank" class="open_lotteryNumb_chart yopen_explain"  href="{:U('Trend/trend_pk10',array('code'=>$nowcpinfo['name']))}">走势图</a>
                    |
            ...
            <div class="least_luckMember">
                ...
                <ul class="ranking_list sum_icon ranking_scroll">
                   ...
                   <div class=&quot;media-footer&quot; style=&quot;padding-top:3px;&quot;>
                       <volist name="value['k3names']" offset="0" length="14"  id="val">
